@extends('masterGeneral')

@section('title', 'Clicker Game')

@section('content')

<style>
#clicker-box {
  min-height: 50vh; /* use "vh" instead of % */
  min-width: 400px;
}
...
<div class="container">
    <div class="row">
        <div id="clicker-box" class="col-4 offset-3 teal lighten-5">
            <div><h4>Total Coins:</h4><h5>@{{totalCoins}}</h5></div>
            <div><h6>Avaliable for spending:</h6><p>@{{expendableCoins}}</p></div>
            <button v-on:click="addClick">The Clicker!</button>
